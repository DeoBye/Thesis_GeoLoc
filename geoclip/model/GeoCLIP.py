...
class GeoCLIP(nn.Module):
    def __init__(self, from_pretrained=True, queue_size=4096, loss_fn = "entropywithdis"):                      ######
        super().__init__()
    ...
    def _load_weights(self):
        ...
        # self.image_encoder.mlp.load_state_dict(torch.load("/root/geo-clip/experiments/geoclipval/epoch_1/image_encoder_mlp_weights.pth", map_location="cpu"))
        # self.location_encoder.load_state_dict(torch.load("/root/geo-clip/experiments/geoclipval/epoch_1/location_encoder_weights.pth", map_location="cpu"))
        # self.logit_scale = nn.Parameter(torch.load("/root/geo-clip/experiments/geoclipval/epoch_1/logit_scale_weights.pth",map_location="cpu"))
    ...
    def forward(self, image, location):
        ...
        if self.loss_fn == 'crossentropy' or self.loss_fn == 'entropywithdis':
